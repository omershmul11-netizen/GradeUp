...
INSERT INTO `student_subject_grades` (`grade_id`, `student_id`, `subject_id`, `latest_grade`) VALUES
    (9001, 9001, 9001, 68), (9002, 9002, 9001, 66),
    (9003, 9003, 9001, 64), (9004, 9004, 9001, 69),
    (9005, 9005, 9001, 63), (9006, 9006, 9001, 67),
    (9007, 9007, 9001, 65), (9008, 9008, 9001, 70),
    (9101, 9001, 9003, 61), (9102, 9002, 9003, 62),
    (9103, 9003, 9003, 63), (9104, 9004, 9003, 64),
    (9105, 9005, 9003, 65), (9106, 9006, 9003, 66),
    (9107, 9007, 9003, 67), (9108, 9008, 9003, 68),
    (9109, 9009, 9003, 69), (9110, 9010, 9003, 70),
    (9111, 9011, 9003, 62), (9112, 9012, 9003, 64),
    (9113, 9013, 9003, 66), (9114, 9014, 9003, 68),
    (9115, 9015, 9003, 69), (9116, 9016, 9003, 70),
    (9201, 9019, 9002, 64), (9202, 9020, 9002, 67),
    (9203, 9021, 9002, 69), (9204, 9022, 9002, 65),
    (9205, 9023, 9002, 68), (9206, 9024, 9002, 63);

INSERT INTO `tutoring_groups`
    (`group_id`, `subject_id`, `grade_level`, `teacher_id`, `day_of_week`, `start_time`, `end_time`, `status`)
VALUES
    (9101, 9001, '10', 9001, 'Sunday', '16:00:00', '17:00:00', 'approved'),
    (9102, 9002, '11', 9004, 'Tuesday', '17:00:00', '18:00:00', 'approved');
